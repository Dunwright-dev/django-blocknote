...
def test_no_manifest_file_found():
    ...
    with patch("django.contrib.staticfiles.finders.find") as mock_find:
        ...
        result = get_vite_asset("src/blocknote.ts")
        assert result == "django_blocknote/src/blocknote.ts"


def test_blocknote_ts_with_valid_manifest(temp_static_dir):
    """Test successful lookup of blocknote.js asset."""
    static_dir, django_blocknote_dir = temp_static_dir

    manifest_data = {
        "src/blocknote.ts": {"file": "js/blocknote.abc123.js", "isEntry": True},
    }
...
def test_unknown_asset_fallback(temp_static_dir):
    ...
    manifest_data = {"src/blocknote.ts": {"file": "js/blocknote.abc123.js"}}
...
def test_manifest_entry_empty_file_value(temp_static_dir):
    ...
    manifest_data = {"src/blocknote.ts": {"file": "", "isEntry": True}}
...
def test_complex_manifest_structure(temp_static_dir):
    ...
    manifest_data = {
        "src/blocknote.ts": {
            "file": "js/blocknote-BwcJof8s.js",
            "name": "blocknote",
            "src": "src/blocknote.ts",
            "isEntry": True,
            "imports": ["_commonjsHelpers-BosuxZz1.js"],
            "css": ["assets/blocknote-DfGqMuPF.css"],
        },
        "style.css": {"file": "css/style-B8nJQq7v.css", "src": "style.css"},
        "_commonjsHelpers-BosuxZz1.js": {"file": "assets/_commonjsHelpers-BosuxZz1.js"},
    }
    ...
    with patch("django.contrib.staticfiles.finders.find") as mock_find:
        ...
        js_result = get_vite_asset("src/blocknote.ts")
        assert js_result == "django_blocknote/js/blocknote-BwcJof8s.js"

        css_result = get_vite_asset("blocknote.css")
        assert css_result == "django_blocknote/css/style-B8nJQq7v.css"
